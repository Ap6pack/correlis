...
1. Read `docs/ARCHITECTURE.md`, `docs/DATA_MODEL.md`, and the relevant ADRs.
2. Add tests for every contract, rule, or state-transition change.
3. Do not place source-specific fields in canonical top-level models without an ADR.
